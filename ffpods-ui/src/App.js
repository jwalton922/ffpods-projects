...
class App extends Component {
  ...
  _handleBuildPlayList = (clips) => {
    ...
    for (var i = 0; i < clips.length; i++) {
      var clip = clips[i];
      var label = clip._source.player + " " + clip._source.podcast + " " + clip._source.episodeTitle;
      var track = { src: clip._source.s3Location, label: label, text: clip._source.clipText };
